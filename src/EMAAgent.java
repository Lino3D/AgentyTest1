...
public class EMAAgent extends Agent {
    ...
    protected void setup() {
        ...
        Addresses.add(new Address("http://192.168.56.1:7778/acc", "Master@192.168.90.107:1099/JADE"));
        // The rest belongs to the receivers
        Addresses.add(new Address("http://192.168.56.1:7778/acc", "MichalMCA@192.168.56.1:1099/JADE"));
        //ddresses.add(new Address("http://192.168.56.1:7778/acc", "MichalSA@192.168.56.1:1099/JADE"));

        SpammerAddresses = new ArrayList<>();
        SpammerAddresses.add(new Address("http://192.168.56.1:7778/acc", "MichalSA@192.168.56.1:1099/JADE"));
